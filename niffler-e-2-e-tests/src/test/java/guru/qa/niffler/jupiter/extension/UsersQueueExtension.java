...
public class UsersQueueExtension implements
    ...
    static {
        EMPTY_USERS.add(new StaticUser("iegafarov", "iegafarov", null, null, null));
        WITH_FRIEND_USERS.add(new StaticUser("duck", "12345", "easy", null, null));
        WITH_INCOME_REQUEST_USERS.add(new StaticUser("easy", "12345", null, "iegafarov", null));
        WITH_OUTCOME_REQUEST_USERS.add(new StaticUser("bill", "12345", null, null, "ilgiz"));
    }
