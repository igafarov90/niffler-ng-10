...
public class SnackbarMessages {
    ...
    public static final String ARCHIVING_CATEGORY = "Category %s is archived";
    ...
    public static final String SPENDING_DELETED = "Spendings succesfully deleted";
    ...
    public static String archivingCategory(String categoryName) {
        return String.format(ARCHIVING_CATEGORY, categoryName);
    }
}
